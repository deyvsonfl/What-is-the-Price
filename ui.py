...
class BudgetApp(tk.Tk):
    ...
    def consultar_precos(self):
        ...
        # Custo adicional (os 2 já estão inclusos)
        extra_furos = max(n_furos - 2, 0) * 5.00
        extra_cortes = max(n_cortes - 2, 0) * 6.00
        extra_vincos = max(n_vincos - 2, 0) * 6.00
    ...
    def abrir_gerenciar(self):
        ...
        # Mapeia o ID do item do Treeview com o comb_id do banco
        id_para_comb = {}
